...
my_interfaces__msg__ReloadFlag__create()
{
  ...
  my_interfaces__msg__ReloadFlag * msg = (my_interfaces__msg__ReloadFlag *)allocator.allocate(sizeof(my_interfaces__msg__ReloadFlag), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__msg__ReloadFlag));
  bool success = my_interfaces__msg__ReloadFlag__init(msg);
  if (!success) {
...
my_interfaces__msg__ReloadFlag__destroy(my_interfaces__msg__ReloadFlag * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_interfaces__msg__ReloadFlag__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_interfaces__msg__ReloadFlag__Sequence__init(my_interfaces__msg__ReloadFlag__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__msg__ReloadFlag * data = NULL;

  if (size) {
    data = (my_interfaces__msg__ReloadFlag *)allocator.zero_allocate(size, sizeof(my_interfaces__msg__ReloadFlag), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__msg__ReloadFlag__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_interfaces__msg__ReloadFlag__fini(&data[i - 1]);
      }
...
my_interfaces__msg__ReloadFlag__Sequence__fini(my_interfaces__msg__ReloadFlag__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__msg__ReloadFlag__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__msg__ReloadFlag__Sequence * array = (my_interfaces__msg__ReloadFlag__Sequence *)allocator.allocate(sizeof(my_interfaces__msg__ReloadFlag__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__msg__ReloadFlag__Sequence__init(array, size);
  if (!success) {
...
my_interfaces__msg__ReloadFlag__Sequence__destroy(my_interfaces__msg__ReloadFlag__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__msg__ReloadFlag__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__msg__ReloadFlag__Sequence__are_equal(const my_interfaces__msg__ReloadFlag__Sequence * lhs, const my_interfaces__msg__ReloadFlag__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__msg__ReloadFlag__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__msg__ReloadFlag__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__msg__ReloadFlag);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__msg__ReloadFlag * data =
      (my_interfaces__msg__ReloadFlag *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__msg__ReloadFlag__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__msg__ReloadFlag__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__msg__ReloadFlag__copy(
