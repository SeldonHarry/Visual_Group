...
class Metaclass_GameStatusMsgBoard2PC(type):
    """Metaclass of message 'GameStatusMsgBoard2PC'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.msg.GameStatusMsgBoard2PC')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__game_status_msg_board2_pc
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__game_status_msg_board2_pc
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__game_status_msg_board2_pc
            cls._TYPE_SUPPORT = module.type_support_msg__msg__game_status_msg_board2_pc
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__game_status_msg_board2_pc
...
class GameStatusMsgBoard2PC(metaclass=Metaclass_GameStatusMsgBoard2PC):
    """Message class 'GameStatusMsgBoard2PC'."""
    ...
    def remain_hp(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'remain_hp' field must be an unsigned integer in [0, 255]"
    ...
    def max_hp(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'max_hp' field must be an unsigned integer in [0, 255]"
        self._max_hp = value
