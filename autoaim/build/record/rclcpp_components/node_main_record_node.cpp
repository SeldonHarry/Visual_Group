...
#define NODE_MAIN_LOGGER_NAME "record_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librecord.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<recorder::RecordNode>";
