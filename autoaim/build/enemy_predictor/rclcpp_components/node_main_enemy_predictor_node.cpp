...
#define NODE_MAIN_LOGGER_NAME "enemy_predictor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libenemy_predictor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<predictor::PredictorNode>";
