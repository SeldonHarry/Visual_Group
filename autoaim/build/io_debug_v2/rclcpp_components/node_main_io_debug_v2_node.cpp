...
#define NODE_MAIN_LOGGER_NAME "io_debug_v2_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libio_debug_v2.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<minipc::MiniPcNode>";
