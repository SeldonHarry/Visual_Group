    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.msg.DetectionResult')
            logger.debug(
            ...
            from my_interfaces.msg import DetectedArmor
            if DetectedArmor.__class__._TYPE_SUPPORT is None:
                DetectedArmor.__class__.__import_type_support__()
...
class DetectionResult(metaclass=Metaclass_DetectionResult):
    ...
    _fields_and_field_types = {
        ...
        'armors': 'sequence<my_interfaces/DetectedArmor>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'Image'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Quaternion'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['my_interfaces', 'msg'], 'DetectedArmor')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, DetectedArmor) for v in value) and
                 True), \
                "The 'armors' field must be a set or sequence and each value of type 'DetectedArmor'"
        self._armors = value
