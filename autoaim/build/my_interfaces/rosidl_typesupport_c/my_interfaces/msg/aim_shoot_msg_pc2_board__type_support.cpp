...
static const _AimShootMsgPC2Board_type_support_symbol_names_t _AimShootMsgPC2Board_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, AimShootMsgPC2Board)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interfaces, msg, AimShootMsgPC2Board)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_interfaces, msg, AimShootMsgPC2Board)() {
  return &::my_interfaces::msg::rosidl_typesupport_c::AimShootMsgPC2Board_message_type_support_handle;
}
