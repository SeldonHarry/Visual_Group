...
static const _GameStatusPC2Board_type_support_symbol_names_t _GameStatusPC2Board_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, GameStatusPC2Board)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interfaces, msg, GameStatusPC2Board)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_interfaces, msg, GameStatusPC2Board)() {
  return &::my_interfaces::msg::rosidl_typesupport_c::GameStatusPC2Board_message_type_support_handle;
}
