...
static const _NavigationBoard2PC_type_support_symbol_names_t _NavigationBoard2PC_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, NavigationBoard2PC)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces, msg, NavigationBoard2PC)),
  }
};
...
{
  return &::my_interfaces::msg::rosidl_typesupport_cpp::NavigationBoard2PC_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interfaces, msg, NavigationBoard2PC)() {
  return get_message_type_support_handle<my_interfaces::msg::NavigationBoard2PC>();
}
