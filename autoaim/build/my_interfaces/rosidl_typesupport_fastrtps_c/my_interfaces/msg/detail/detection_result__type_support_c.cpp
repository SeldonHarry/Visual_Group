...
#include "my_interfaces/msg/detail/detection_result__rosidl_typesupport_fastrtps_c.h"
...
#include "my_interfaces/msg/detail/detected_armor__functions.h"  // armors
...
using _DetectionResult__ros_msg_type = my_interfaces__msg__DetectionResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: armors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_interfaces, msg, DetectedArmor
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: armors
  {
    ...
    if (ros_message->armors.data) {
      my_interfaces__msg__DetectedArmor__Sequence__fini(&ros_message->armors);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_interfaces__msg__DetectedArmor(
...
static uint32_t _DetectionResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__DetectionResult(
  ...
  size_t current_alignment)
{
  ...
  // member: armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_interfaces__msg__DetectedArmor(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__msg__DetectionResult;
    is_plain =
      (
...
static size_t _DetectionResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__DetectionResult(
