...
#define NODE_MAIN_LOGGER_NAME "coreio_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcoreio.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<coreio::MiniPcNode>";
