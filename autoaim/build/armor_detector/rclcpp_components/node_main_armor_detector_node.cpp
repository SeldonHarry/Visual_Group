...
#define NODE_MAIN_LOGGER_NAME "armor_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<detector::DetectorNode>";
