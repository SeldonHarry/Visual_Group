...
#define NODE_MAIN_LOGGER_NAME "fakeio_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfakeio.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fakeio::FakeioNode>";
