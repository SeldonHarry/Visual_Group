...
#define NODE_MAIN_LOGGER_NAME "fast_record_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfast_record.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<recorder::RecorderNode>";
