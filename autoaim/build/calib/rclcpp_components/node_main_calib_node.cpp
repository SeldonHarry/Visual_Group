...
#define NODE_MAIN_LOGGER_NAME "calib_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcalib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<calibrate::CalibNode>";
