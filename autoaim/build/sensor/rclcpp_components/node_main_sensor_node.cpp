...
#define NODE_MAIN_LOGGER_NAME "sensor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsensor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<sensor::SensorNode>";
