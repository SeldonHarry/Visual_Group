...
public:
    EnemyPredictor(std::shared_ptr<::RobotStatus> robot_status,
...
private:
    ...
    std::shared_ptr<::RobotStatus> robot_status_;

    // for debug
    Stm32Shoot stm32_shoot;
    ros2addon::debug::PeriodicRecorder<double, double> processing_time_recorder {
        ([](const double& t, const double& t1) -> bool { return t < t1; }),
        -86400.
    };
    ros2addon::debug::PeriodicAverage<double, double> desired_yaw_average { 200u, -86400. };
